...
public class allstudentresult extends javax.swing.JFrame {
  Connection con=null;
    ...
    public allstudentresult() {
        initComponents();
        try{
            String extractQuery="select * from user";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(934, 13, 60, 60));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 106, 121, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 158, 1040, 360));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1060, -1));
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try{
            String extractQuery="select * from user where marks >='"+marks+"'";
           con =DriverManager.getConnection("jdbc:mysql://localhost/javaquiz", "root", "");
           pst = con.prepareStatement(extractQuery);
           rs = pst.executeQuery(); 
